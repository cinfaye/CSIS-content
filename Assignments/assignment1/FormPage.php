                    ...
                    <form  action = "ResultPage.php" method = "post">
                        <div class="form-group">
                            ...
                            <div id="Gender" class="form-check form-check-inline">
                                <input type="radio" value="Male" name="gender" class="form-check-input" id="genderM"><lable for="gender">Male</lable>  
                                <input type="radio" value="Female" name="gender" class="form-check-input" id="genderF"><lable for="gender">Female</lable>
                            </div>
                            <br>
