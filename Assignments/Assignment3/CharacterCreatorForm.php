                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input id="Create" name="Action" class="btn btn-primary btn-outline-dark" value='Create' onclick="return create()" type="submit"><br>
                                    <input id="Update" name="Action" class="btn btn-primary btn-outline-dark" value='Update' onclick="return update()" type="submit">
                                </div>
                            </div>
