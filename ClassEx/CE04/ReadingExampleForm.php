                ...
                <form class="form-group" action="ReadingExampleResult.php" method="post">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="CapName" name="CapName" type="text" placeholder="Kirk" class="form-control input-md">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="CapAge" name="CapAge" type="number" min="18" max="36" placeholder="22" class="form-control input-md">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="ShipName" name="ShipName" type="text" placeholder="Serenity" class="form-control input-md">
