        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    $dist = PlanetDistance($planets[$Departure]['x'], $planets[$Departure]['y'], $planets[$Departure]['z'], $planets[$Arrival]['x'], $planets[$Arrival]['y'], $planets[$Arrival]['z']);
                    printf("<p>The distance is: %.2f", $dist);
                    printf("<p>The time it should take is: %.2f cycles</p>", ($dist/$ships[$theShip]['speed']));
                    ?>
                </div>
            </div>
        </div>
